...
var Stamen_Toner = L.tileLayer('https://stamen-tiles-{s}.a.ssl.fastly.net/toner-hybrid/{z}/{x}/{y}{r}.{ext}', {
...
$.get('map/data_updated_fall22.csv', function (csvString) {
...
$.getJSON("map/CD_S.json", function (data) {
    L.geoJson(data, {
